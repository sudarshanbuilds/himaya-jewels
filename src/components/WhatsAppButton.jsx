...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white shadow-xl hover:shadow-2xl rounded-full transition-all duration-300 hover:pr-5"
